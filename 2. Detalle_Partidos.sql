SELECT   country.name AS COUNTRY, league.name AS LEAGUE, season AS SEASON, date AS DATE, Equipo_Local.team_long_name AS LOCAL_TEAM, Equipo_visita.team_long_name AS AWAY_TEAM, home_team_goal AS LOCAL_GOAL, away_team_goal AS AWAY_GOAL
FROM Match 
